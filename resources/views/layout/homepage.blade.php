                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 megamenu-item">
                                                                <ul class="menu-list">
                                                                    ...
                                                                    <li>
                                                                        <a
                                                                            href="/barangs/{{$subcategory->id}}">{{$subcategory->nama_subkategori}}</a>
                                                                    </li>
                                                                    @endforeach
                                                                </ul>
                                                            </div>
              ...
              <div class="flex-child flex-right nav-right hidden-sm hidden-xs">
                <ul>
                  ...
                  <li class="nav-cart">
                    <div class="nav-cart-outer">
                      <div class="nav-cart-inner">
                        <a href="/keranjang" class="nav-cart-icon"></a>
                      </div>
                    </div>
                  </li>
                  <li class="nav-register">
            ...
            <div class="row">
              ...
              <div class="col-md-3 col-sm-12 col-xs-12">
                <div class="widget footer-about-us">
                  ...
                  <p class="mb-30">Gudang Jersey is a very slick and clean eCommerce</p>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-sm-6 copyright sm-text-center">
                <span>
                  &copy; 2023 Gudang Jersey <a href="http://deothemes.com">DeoThemes</a>
                </span>
              </div>
